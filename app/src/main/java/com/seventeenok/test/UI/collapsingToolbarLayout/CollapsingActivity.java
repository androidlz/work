package com.seventeenok.test.UI.collapsingToolbarLayout;
...
import com.seventeenok.test.UI.scrollAnimator.FabScrollListener;
import com.seventeenok.test.UI.recyclerview.MyRecyclerAdapter;
import com.seventeenok.test.UI.scrollAnimator.MyScrollView;
import com.seventeenok.test.R;

import java.util.ArrayList;


public class CollapsingActivity extends AppCompatActivity implements FabScrollListener.HideScorllListener {
...
//        recyclerview.addOnScrollListener(new FabScrollListener(this));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(CollapsingActivity.this.findViewById(R.id.root), "哈哈哈哈", Snackbar.LENGTH_LONG)
                        .setAction("确定", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(CollapsingActivity.this, "确定", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
            }
