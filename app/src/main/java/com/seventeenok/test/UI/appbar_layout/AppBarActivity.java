package com.seventeenok.test.UI.appbar_layout;
...
public class AppBarActivity extends AppCompatActivity implements FabScrollListener.HideScorllListener {
...
//        recyclerview.addOnScrollListener(new FabScrollListener(this));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(AppBarActivity.this.findViewById(R.id.root), "哈哈哈哈", Snackbar.LENGTH_LONG)
                        .setAction("确定", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(AppBarActivity.this, "确定", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
            }
